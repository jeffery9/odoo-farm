...
class TestTourFarmFinancialValuation(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_financial_valuation is defined and retrievable """
        ...
        xml_id = "farm_financial_valuation.action_financial_asset_valuation"
        if xml_id:
