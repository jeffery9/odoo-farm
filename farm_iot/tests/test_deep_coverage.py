...
class TestDeepCoverageFarmIot(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['iot.device.mapping', 'farm.telemetry', 'agri.digital.twin.scene', 'farm.digital.twin.scene', 'farm.command.log', 'iiot.device', 'agri.digital.twin.marker', 'agri.telemetry', 'farm.automation.rule', 'farm.location', 'farm.digital.twin.marker', 'iot.telemetry.buffer', 'stock.location']
