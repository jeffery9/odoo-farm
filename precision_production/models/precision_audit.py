...
class PrecisionInterventionBasis(models.Model):
    ...
    deviation_delta = fields.Float("Delta", compute='_compute_delta', store=True, precompute=True)
    res_model = fields.Char("Related Model")
    res_id = fields.Many2oneReference("Related Record", model_field='res_model')
