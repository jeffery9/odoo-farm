...
class TestTourPrecisionProduction(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for precision_production is defined and retrievable """
        ...
        xml_id = "precision_production.action_recipe_execution_dashboard"
        if xml_id:
