...
class TestDeepCoverageFarmFinancialBasic(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['account.move.line', 'agri.cost.template', 'agri.cost.calculation.line', 'farm.processing.cost', 'project.task', 'agri.cost.calculation', 'account.move', 'farm.cpa.analysis', 'farm.mortality.amortization', 'farm.cost.wip.transfer']
