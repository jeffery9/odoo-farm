...
class TestDeepCoverageFarmEsg(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['esg.framework', 'esg.assessment', 'esg.target', 'esg.indicator', 'esg.performance.report', 'esg.assessment.line']
