...
class AgriQualitySample(models.Model):
    _name = 'agri.quality.sample'
    _description = 'Agricultural Quality Sample'
    ...
    check_ids = fields.One2many('agri.quality.check', 'sample_id', string="Quality Checks")

    @api.model_create_multi
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', _('New')) == _('New'):
                vals['name'] = self.env['ir.sequence'].next_by_code('agri.quality.sample') or _('SMP')
