...
class TestTourFarmQuality(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_quality is defined and retrievable """
        ...
        xml_id = "farm_quality.action_farm_quality_check"
        if xml_id:
