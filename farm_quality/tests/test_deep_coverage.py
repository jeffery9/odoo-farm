...
class TestDeepCoverageFarmQuality(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'agri.quality.point', 'agri.quality.sample', 'farm.quality.sample', 'agri.quality.alert', 'agri.quality.check', 'farm.haccp.point', 'farm.haccp.check', 'stock.picking']
