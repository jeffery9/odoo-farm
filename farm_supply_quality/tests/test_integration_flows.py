...
class TestIntegrationFarmSupplyQuality(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['quality.based.pricing']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_supply_quality are available """
