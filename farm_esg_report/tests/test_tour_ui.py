...
class TestTourFarmEsgReport(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_report is defined and retrievable """
        ...
        xml_id = "farm_esg_report.action_esg_report"
        if xml_id:
