...
class TestIntegrationFarmKnowledge(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['agricultural.knowledge', 'farm.pest.disease', 'faq.entry', 'agri.pest.disease']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_knowledge are available """
