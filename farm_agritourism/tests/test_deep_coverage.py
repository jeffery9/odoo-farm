...
class TestDeepCoverageFarmAgritourism(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.resource', 'sale.order', 'sale.order.line', 'farm.resource.usage', 'farm.booking', 'product.template', 'farm.agritourism.operation']
