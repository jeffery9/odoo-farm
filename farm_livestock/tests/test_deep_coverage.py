...
class TestDeepCoverageFarmLivestock(TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'agri.isl.lot.livestock', 'agri.isl.livestock.task', 'farm.livestock.event', 'agri.isl.livestock.bom.line', 'farm.livestock.house.env', 'agri.isl.livestock.recipe', 'mrp.production', 'stock.picking', 'mrp.bom', 'farm.animal.health.wizard', 'farm.breeding.record']
