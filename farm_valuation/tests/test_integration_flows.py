...
class TestIntegrationFarmValuation(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['agri.biological.asset.fair.valuation', 'farm.market.price']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_valuation are available """
