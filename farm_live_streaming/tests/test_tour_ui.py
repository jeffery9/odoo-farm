...
class TestTourFarmLiveStreaming(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_live_streaming is defined and retrievable """
        ...
        xml_id = "farm_live_streaming.action_douyin_qualification"
        if xml_id:
