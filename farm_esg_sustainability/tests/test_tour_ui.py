...
class TestTourFarmEsgSustainability(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_sustainability is defined and retrievable """
        ...
        xml_id = "farm_esg_sustainability.action_sustainability_metric"
        if xml_id:
