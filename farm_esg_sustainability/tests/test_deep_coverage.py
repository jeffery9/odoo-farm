...
class TestDeepCoverageFarmEsgSustainability(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.sustainability.dashboard', 'farm.sustainability.metric', 'farm.sustainability.metric.value.wizard', 'farm.sustainability.report', 'agri.sustainability.metric.value.wizard', 'agri.sustainability.metric.value', 'agri.sustainability.metric', 'farm.sustainability.metric.value', 'farm.sustainability.dashboard', 'agri.sustainability.report', 'farm.agricultural.campaign']
