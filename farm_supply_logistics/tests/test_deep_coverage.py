...
class TestDeepCoverageFarmSupplyLogistics(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.transport.temperature', 'cold.storage.zone', 'precooling.process', 'farm.vehicle', 'seasonal.stock.forecast', 'cold.storage.facility', 'product.template', 'cold.storage.temperature.log', 'stock.picking', 'cold.storage.inventory']
