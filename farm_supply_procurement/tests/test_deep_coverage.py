...
class TestDeepCoverageFarmSupplyProcurement(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['purchase.order', 'joint.procurement.configuration', 'sale.order', 'vmi.agreement', 'product.template', 'purchase.order.line', 'vmi.stock.monitoring', 'joint.procurement.order']
