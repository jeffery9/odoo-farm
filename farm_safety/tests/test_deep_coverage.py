...
class TestDeepCoverageFarmSafety(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'farm.prevention.template', 'farm.biosafety.access.log', 'project.task', 'stock.picking', 'farm.prevention.line']
