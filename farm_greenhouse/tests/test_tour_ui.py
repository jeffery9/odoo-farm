...
class TestTourFarmGreenhouse(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_greenhouse is defined and retrievable """
        ...
        xml_id = "farm_greenhouse.action_ecommerce_platform"
        if xml_id:
