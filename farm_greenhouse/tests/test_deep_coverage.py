...
class TestDeepCoverageFarmGreenhouse(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.greenhouse.control.action', 'farm.ecommerce.platform', 'farm.greenhouse.control.rule', 'farm.government.data.report', 'farm.location', 'farm.ecommerce.sync.log', 'agri.biological.twin', 'farm.greenhouse.energy.log', 'farm.government.platform.config', 'farm.ecommerce.listing.wizard']
