...
class IndustryCarbonModel(models.Model):
    ...
    _description = 'Industry Specific Carbon Model'
    ...
    calculation_rule_ids = fields.One2many('farm.sustainability.industry.calculation.rule', 'model_id', 'Calculation Rules')
    ...
    def action_apply_model(self, product_or_operation):
        ...
        result = {
            ...
            'direct_coefficient': self.direct_emission_coefficient,
