...
class MrpProduction(models.Model):
    ...
    def button_mark_done(self):
        """ 强制平衡校验、关键质量拦截、损耗率硬拦截并建立批次溯源 [US-04-02, US-14-03, US-14-16, US-14-19] """
        for mo in self:
            # 1. 物料平衡校验 [US-14-06]
            ...
            # 2. 损耗容差硬拦截 [US-14-16] (Core-Closure)
            if mo.bom_id and mo.bom_id.max_loss_rate and mo.loss_rate > mo.bom_id.max_loss_rate:
                # 创建异常处置 Activity [Workflow] - 质检主管审批
            ...
            # 3. 关键工艺质量硬拦截 [US-14-19] (Core-Closure)
