...
class TestTourFarmMultiFarmQuality(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_multi_farm_quality is defined and retrievable """
        ...
        xml_id = "farm_multi_farm_quality.action_quality_control_standard_list"
        if xml_id:
