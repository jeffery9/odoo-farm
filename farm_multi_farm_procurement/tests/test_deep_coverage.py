...
class TestDeepCoverageFarmMultiFarmProcurement(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['hub.spoke.distribution', 'cooperative.entity', 'internal.settlement', 'netting.receivable.line', 'joint.procurement.po.member', 'joint.procurement.po', 'netting.payable.line', 'marketplace.demand.match', 'joint.procurement.line', 'procurement.planning', 'cooperative.member', 'internal.marketplace', 'procurement.allocation.line', 'joint.procurement', 'netting.settlement', 'hub.spoke.distribution.line', 'procurement.planning.line']
