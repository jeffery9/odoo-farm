...
class TestTourFarmMultiFarmProcurement(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_multi_farm_procurement is defined and retrievable """
        ...
        xml_id = "farm_multi_farm_procurement.action_joint_procurement_po_list"
        if xml_id:
