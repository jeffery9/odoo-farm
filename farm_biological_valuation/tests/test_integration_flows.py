...
class TestIntegrationFarmBiologicalValuation(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['agri.valuation.stage.coefficient', 'agri.biological.asset.valuation']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_biological_valuation are available """
