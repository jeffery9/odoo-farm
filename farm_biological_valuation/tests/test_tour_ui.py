...
class TestTourFarmBiologicalValuation(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_biological_valuation is defined and retrievable """
        ...
        xml_id = "farm_biological_valuation.action_biological_asset_valuation"
        if xml_id:
