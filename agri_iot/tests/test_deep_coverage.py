...
class TestDeepCoverageAgriIot(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['iiot.device', 'iiot.telemetry', 'iiot.firmware', 'iiot.telemetry.rule', 'iiot.device.profile', 'iiot.update']
