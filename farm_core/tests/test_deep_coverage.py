...
class TestDeepCoverageFarmCore(TransactionCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.industry.task.template', 'farm.industry.product.category', 'farm.industry.package.wizard', 'farm.task', 'agri.soil.analysis', 'farm.biological.asset', 'agri.industry.variety', 'agri.biological.growth.curve', 'stock.move', 'farm.core.gis.utils', 'res.company', 'stock.move.line', 'stock.lot', 'agri.performance.monitor', 'farm.core.common.fields', 'agri.value.bridge', 'agri.industry.data.package', 'agri.neighborhood.registry', 'farm.location', 'agri.clearing.netting.engine', 'agri.biological.asset', 'agri.audit.log', 'res.partner', 'agri.clearing.ledger', 'agri.location', 'farm.activity', 'agri.dividend.pool', 'farm.industry.uom.conversion', 'agri.industry.physio.stage', 'agri.geospatial.geofence']
