...
class TestTourFarmCore(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_core is defined and retrievable """
        ...
        xml_id = "farm_core.action_industry_data_package_list"
        if xml_id:
