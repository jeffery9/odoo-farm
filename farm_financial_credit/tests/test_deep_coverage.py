...
class TestDeepCoverageFarmFinancialCredit(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.credit.score', 'farm.coop.settlement', 'farm.futures.hedging', 'res.partner', 'farm.risk.assessment', 'farm.livestock.asset.loan', 'project.task', 'farm.input.financing', 'farm.carbon.credit.finance', 'farm.industry.initialization', 'agri.industry.initialization.wizard', 'farm.supply.chain.finance', 'farm.loan']
