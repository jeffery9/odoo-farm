...
class TestDeepCoveragePrecisionProductionIot(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['precision.iot.device', 'precision.recipe.control', 'precision.iot.sensor', 'precision.recipe.phase', 'precision.iot.reading', 'precision.iot.command.log']
