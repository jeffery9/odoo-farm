...
class TestTourPrecisionProductionIot(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for precision_production_iot is defined and retrievable """
        ...
        xml_id = "precision_production_iot.action_precision_iot_command_log"
        if xml_id:
