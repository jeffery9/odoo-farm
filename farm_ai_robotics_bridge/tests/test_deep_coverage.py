...
class TestDeepCoverageFarmAiRoboticsBridge(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['ai.autonomous.orchestrator', 'agri.a2a.negotiation', 'ai.autonomous.mission.log']
