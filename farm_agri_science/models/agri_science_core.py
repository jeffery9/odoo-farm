...
class AgriPhysiologyProfile(models.Model):
    ...
    # [US-045-02] 基点温度定义 (Cardinal Temperatures)
    ...
    # [US-045-03] 逻辑斯蒂生长参数 (Logistic Growth Parameters)
    ...
    # [US-108-13] 品种响应曲线参数 (Nutrient Response Parameters - Mitscherlich Equation)
