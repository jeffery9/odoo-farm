...
class TestDeepCoverageFarmEquipment(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.equipment.checklist.line', 'maintenance.equipment', 'farm.equipment.checklist', 'farm.battery', 'farm.equipment.log']
