...
class TestTourFarmEsgEnvironmental(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_environmental is defined and retrievable """
        ...
        xml_id = "farm_esg_environmental.action_vra_carbon_footprint"
        if xml_id:
