...
class TestDeepCoverageFarmEsgEnvironmental(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.esg.red.line.config', 'esg.environmental.report', 'agri.carbon.ledger', 'agri.carbon.factor', 'agri.vra.water.compliance.history', 'mrp.workorder', 'agri.esg.red.line.monitoring', 'farm.esg.red.line.monitoring', 'farm.esg.red.line.config', 'agri.vra.carbon.footprint', 'agri.vra.soil.health.monitor', 'agri.vra.water.protection.zone']
