...
class TestTourFarmFinancialInsurance(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_financial_insurance is defined and retrievable """
        ...
        xml_id = "farm_financial_insurance.action_farm_crop_yield_insurance"
        if xml_id:
