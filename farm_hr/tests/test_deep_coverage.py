...
class TestDeepCoverageFarmHr(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.agri.skill', 'farm.labor.payment', 'hr.employee', 'farm.labor.payment.line', 'farm.worklog', 'farm.employee.certificate', 'project.task', 'farm.wage.rule']
