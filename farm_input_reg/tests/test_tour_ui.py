...
class TestTourFarmInputReg(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_input_reg is defined and retrievable """
        ...
        xml_id = "farm_input_reg.action_input_registration_database_list"
        if xml_id:
