...
class TestTourFarmEsgCompliance(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_compliance is defined and retrievable """
        ...
        xml_id = "farm_esg_compliance.action_sustainable_product_lifecycle"
        if xml_id:
