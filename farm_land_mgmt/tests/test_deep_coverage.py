...
class TestDeepCoverageFarmLandMgmt(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.land.crop.rotation.history', 'project.project', 'project.task', 'farm.land.health.record', 'farm.soil.analysis', 'agri.land.crop.rotation.history', 'agri.land.health.record']
