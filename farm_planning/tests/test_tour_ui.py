...
class TestTourFarmPlanning(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_planning is defined and retrievable """
        ...
        xml_id = "farm_planning.action_agri_technical_route"
        if xml_id:
