...
class TestDeepCoverageFarmPlanning(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.intervention.template.input', 'agri.scenario.input.forecast', 'agri.scenario', 'agri.technical.route.line', 'agri.technical.route', 'agri.intervention.template']
