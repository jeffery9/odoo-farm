...
class TestTourFarmBreeding(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_breeding is defined and retrievable """
        ...
        xml_id = "farm_breeding.action_farm_nursery_batch"
        if xml_id:
