...
class TestIntegrationFarmProtectedCultivation(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['farm.environmental.log', 'farm.protected.cultivation.operation']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_protected_cultivation are available """
