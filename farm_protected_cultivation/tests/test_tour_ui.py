...
class TestTourFarmProtectedCultivation(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_protected_cultivation is defined and retrievable """
        ...
        xml_id = "farm_protected_cultivation.action_farm_protected_cultivation_operations"
        if xml_id:
