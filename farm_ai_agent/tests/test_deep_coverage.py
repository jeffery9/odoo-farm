...
class TestDeepCoverageFarmAiAgent(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.a2a.negotiation', 'agri.ai.decision.workflow', 'agri.ai.decision.workflow.step', 'agri.a2a.arbitrator', 'agri.mission.step', 'agri.a2a.message', 'ai.autonomous.mission.log', 'agri.ai.coordination.layer', 'agri.ai.decision.context', 'agri.ai.agent.workflow', 'agri.mission.orchestrator', 'agri.ai.decision.rule', 'agri.a2a.protocol', 'agri.mcp.server', 'agri.ai.agent.workflow.step', 'ai.autonomous.orchestrator', 'agri.ai.decision.engine']
