...
class AgriAIDecisionEngine(models.Model):
    ...
    decision_service_ids = fields.Many2many('agri.ai.agent', 'agri_ai_dec_engine_agent_rel', 'engine_id', 'agent_id',  # This should eventually point to agri.ai.agent but kept for initial migration
