...
class TestTourFarmViticulture(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_viticulture is defined and retrievable """
        ...
        xml_id = "farm_viticulture.action_farm_viticulture_plot"
        if xml_id:
