# 🤖 Directory Execution Policy: Algorithms
...
- **Domain**: Agronomic Formulas & AI Models.
- **Rule**: Focus on mathematics, data science, and agronomic logic (e.g., GDD, FCR). Provide clear formulas, input/output definitions, and ensure variables map to actual IoT telemetry data points.
