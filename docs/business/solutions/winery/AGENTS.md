# 🤖 Directory Execution Policy: Winery
...
- **Domain**: Vertical Solution - Winery.
- **Rule**: Detail ISL proxy mappings specifically for `winery` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
