# 🤖 Directory Execution Policy: Symbiosis
...
- **Domain**: Vertical Solution - Symbiosis.
- **Rule**: Detail ISL proxy mappings specifically for `symbiosis` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
