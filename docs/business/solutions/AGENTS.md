# 🤖 Directory Execution Policy: Industry Solutions
...
- **Domain**: Industry Solutions.
- **Rule**: Group by specific vertical (e.g., Tea, Wine). Focus on industry-specific pain points.
