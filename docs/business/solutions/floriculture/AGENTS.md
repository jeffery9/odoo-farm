# 🤖 Directory Execution Policy: Floriculture
...
- **Domain**: Vertical Solution - Floriculture.
- **Rule**: Detail ISL proxy mappings specifically for `floriculture` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
