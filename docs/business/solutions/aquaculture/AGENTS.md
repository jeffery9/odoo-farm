# 🤖 Directory Execution Policy: Aquaculture
...
- **Domain**: Vertical Solution - Aquaculture.
- **Rule**: Detail ISL proxy mappings specifically for `aquaculture` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
