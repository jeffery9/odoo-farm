# 🤖 Directory Execution Policy: Urban Farming
...
- **Domain**: Vertical Solution - Urban Farming.
- **Rule**: Detail ISL proxy mappings specifically for `urban_farming` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
