# 🤖 Directory Execution Policy: Seed Industry
...
- **Domain**: Vertical Solution - Seed Industry.
- **Rule**: Detail ISL proxy mappings specifically for `seed_industry` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
