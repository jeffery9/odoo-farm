# 🤖 Directory Execution Policy: Essential Oils
...
- **Domain**: Vertical Solution - Essential Oils.
- **Rule**: Detail ISL proxy mappings specifically for `essential_oils` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
