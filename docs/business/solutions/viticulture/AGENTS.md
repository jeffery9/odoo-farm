# 🤖 Directory Execution Policy: Viticulture
...
- **Domain**: Vertical Solution - Viticulture.
- **Rule**: Detail ISL proxy mappings specifically for `viticulture` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
