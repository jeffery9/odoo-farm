# 🤖 Directory Execution Policy: Tea
...
- **Domain**: Vertical Solution - Tea.
- **Rule**: Detail ISL proxy mappings specifically for `tea` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
