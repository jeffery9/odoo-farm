# 🤖 Directory Execution Policy: Orchard
...
- **Domain**: Vertical Solution - Orchard.
- **Rule**: Detail ISL proxy mappings specifically for `orchard` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
