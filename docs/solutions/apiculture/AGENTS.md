# 🤖 Directory Execution Policy: Apiculture
...
- **Domain**: Vertical Solution - Apiculture.
- **Rule**: Detail ISL proxy mappings specifically for `apiculture` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
