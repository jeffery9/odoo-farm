# 🤖 Directory Execution Policy: Forestry
...
- **Domain**: Vertical Solution - Forestry.
- **Rule**: Detail ISL proxy mappings specifically for `forestry` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
