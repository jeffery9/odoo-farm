# 🤖 Directory Execution Policy: Haccp
...
- **Domain**: Vertical Solution - Haccp.
- **Rule**: Detail ISL proxy mappings specifically for `haccp` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
