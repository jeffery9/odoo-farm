# 🤖 Directory Execution Policy: Fermentation
...
- **Domain**: Vertical Solution - Fermentation.
- **Rule**: Detail ISL proxy mappings specifically for `fermentation` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
