# 🤖 Directory Execution Policy: Net Vegetables
...
- **Domain**: Vertical Solution - Net Vegetables.
- **Rule**: Detail ISL proxy mappings specifically for `net_vegetables` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
