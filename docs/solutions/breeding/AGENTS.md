# 🤖 Directory Execution Policy: Breeding
...
- **Domain**: Vertical Solution - Breeding.
- **Rule**: Detail ISL proxy mappings specifically for `breeding` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
