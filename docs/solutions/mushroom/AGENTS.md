# 🤖 Directory Execution Policy: Mushroom
...
- **Domain**: Vertical Solution - Mushroom.
- **Rule**: Detail ISL proxy mappings specifically for `mushroom` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
