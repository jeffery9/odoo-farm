# 🤖 Directory Execution Policy: Aquatic Processing
...
- **Domain**: Vertical Solution - Aquatic Processing.
- **Rule**: Detail ISL proxy mappings specifically for `aquatic_processing` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
