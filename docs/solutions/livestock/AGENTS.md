# 🤖 Directory Execution Policy: Livestock
...
- **Domain**: Vertical Solution - Livestock.
- **Rule**: Detail ISL proxy mappings specifically for `livestock` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
