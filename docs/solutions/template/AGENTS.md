# 🤖 Directory Execution Policy: Template
...
- **Domain**: Vertical Solution - Template.
- **Rule**: Detail ISL proxy mappings specifically for `template` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
