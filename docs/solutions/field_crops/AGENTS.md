# 🤖 Directory Execution Policy: Field Crops
...
- **Domain**: Vertical Solution - Field Crops.
- **Rule**: Detail ISL proxy mappings specifically for `field_crops` (e.g., how `mrp.production` maps to this sector). Define precise ESG red lines, HACCP control points, and specialized IoT integrations unique to this domain.
