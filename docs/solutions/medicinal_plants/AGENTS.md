# 🤖 Directory Execution Policy: Medicinal Plants
...
- **Domain**: Roadmaps & Execution Tracking.
- **Rule**: Update task statuses, Kanban boards, and module plans. Ensure alignment between completed code and planned milestones.
