# 🤖 Directory Execution Policy: Governance
...
- **Domain**: Project Standards & Quality Assurance.
- **Rule**: Maintain and enforce TDD standards, Lossless update mandates, PR review criteria, and bilingual coding policies.
