# 🤖 Directory Execution Policy: Product Management & Backlog
...
1. Read the global [AGENTS.md](../AGENTS.md) for Git branching, commit separation, and 4-Layer Architecture mandates.
2. Read the master entry [LLM_START_HERE.md](./LLM_START_HERE.md) for Doc-Driven development paradigms.

## 1. Localized Domain Rules
- **Domain**: Product Management & Backlog.
- **Rule**: Maintain 001-133 sequential numbering. Enforce BDD-style Acceptance Criteria (AC).

## 2. Documentation Constraints
- **Separation of Concerns**: Code and documentation MUST be committed separately.
- **Lossless Update**: Do not delete or simplify existing architectural anchors or requirement tags.
