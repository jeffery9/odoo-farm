# 🤖 Directory Execution Policy: Isl Architecture
...
- **Domain**: ISL (Industry Specialized Layer) Framework.
- **Rule**: Strictly align with the `03_ISL_REFERENCE_MATRIX.md`. Document proxy models, `_inherits` linkages, dynamic redirection, and field protection barriers.
