# 🤖 Directory Execution Policy: Agricultural Ontology
...
- **Domain**: Agricultural Ontology.
- **Rule**: Ensure domain concepts (Biological Assets, Stages) align with international standards.
