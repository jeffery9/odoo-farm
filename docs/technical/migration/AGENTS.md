# 🤖 Directory Execution Policy: Migration
...
- **Domain**: System Architecture & Engineering Specs.
- **Rule**: Document Odoo 19 Mixins, concrete models, bridging logic, and migration SOPs. Use Mermaid.js for architectural diagrams.
