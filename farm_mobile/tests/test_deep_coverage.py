...
class TestDeepCoverageFarmMobile(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.evidence', 'farm.checklist.submission', 'agri.evidence', 'mrp.production', 'farm.checklist.submission.line', 'farm.expert.call', 'farm.checkin', 'farm.sync.queue']
