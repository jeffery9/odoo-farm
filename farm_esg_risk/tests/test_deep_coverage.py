...
class TestDeepCoverageFarmEsgRisk(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.esg.risk.assessment', 'farm.esg.compliance.monitoring', 'agri.esg.kpi', 'agri.esg.compliance.monitoring', 'farm.esg.kpi', 'farm.esg.report.customization', 'farm.esg.risk.assessment', 'farm.esg.stakeholder.engagement', 'farm.esg.data.governance', 'farm.esg.scenarios.analysis', 'farm.esg.supply.chain.rating']
