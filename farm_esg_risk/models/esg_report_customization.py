...
class ESGReportCustomization(models.Model):
    ...
    report_recipients = fields.Many2many('res.partner', 'farm_esg_report_custom_partner_rel', 'customization_id', 'partner_id', string='Report Recipients')
    ...
    # Access control
    allowed_users = fields.Many2many('res.users', 'farm_esg_report_custom_users_rel', 'customization_id', 'users_id', string='Allowed Users',
