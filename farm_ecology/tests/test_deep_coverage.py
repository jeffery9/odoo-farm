...
class TestDeepCoverageFarmEcology(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['agri.ecological.activity', 'farm.ecological.activity', 'agri.sustainability.ecological.zone', 'agri.sustainability.biodiversity.indicator']
