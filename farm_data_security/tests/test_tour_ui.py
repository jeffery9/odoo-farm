...
class TestTourFarmDataSecurity(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_data_security is defined and retrievable """
        ...
        xml_id = "farm_data_security.action_farm_data_classification"
        if xml_id:
