...
class TestDeepCoverageFarmWasteMgmt(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.manure.ledger', 'farm.storage.env', 'farm.manure.batch', 'agri.manure.batch', 'farm.processing.waste', 'agri.manure.ledger']
