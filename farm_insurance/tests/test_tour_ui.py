...
class TestTourFarmInsurance(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_insurance is defined and retrievable """
        ...
        xml_id = "farm_insurance.action_crop_yield_policy"
        if xml_id:
