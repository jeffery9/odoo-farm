...
class TestTourFarmExchange(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_exchange is defined and retrievable """
        ...
        xml_id = "farm_exchange.action_farm_data_exchanger"
        if xml_id:
