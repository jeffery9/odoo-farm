...
class TestDeepCoverageFarmMarketing(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'farm.market.connector', 'res.partner', 'sale.order', 'sale.order.line', 'agri.gi.registry', 'farm.market.demand', 'farm.consumer.feedback']
