...
class TestTourFarmMarketing(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_marketing is defined and retrievable """
        ...
        xml_id = "farm_marketing.action_farm_market_connector"
        if xml_id:
