...
class TestTourFarmProcessing(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_processing is defined and retrievable """
        ...
        xml_id = "farm_processing.action_farm_substitute_wizard"
        if xml_id:
