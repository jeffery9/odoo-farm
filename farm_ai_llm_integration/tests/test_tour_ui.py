...
class TestTourFarmAiLlmIntegration(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_ai_llm_integration is defined and retrievable """
        ...
        xml_id = "farm_ai_llm_integration.action_llm_service"
        if xml_id:
