...
class TestIntegrationFarmFinanceGov(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['account.move', 'farm.rural.revitalization.project']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_finance_gov are available """
