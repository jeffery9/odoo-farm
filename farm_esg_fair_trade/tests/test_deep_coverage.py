...
class TestDeepCoverageFarmEsgFairTrade(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['farm.esg.fair.trade.premium.allocation', 'farm.esg.fair.trade.certificate', 'farm.esg.community.investment', 'farm.esg.labor.condition']
