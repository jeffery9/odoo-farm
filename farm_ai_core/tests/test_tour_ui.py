...
class TestTourFarmAiCore(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_ai_core is defined and retrievable """
        ...
        xml_id = "farm_ai_core.action_ai_model_registry"
        if xml_id:
