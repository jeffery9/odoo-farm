...
class TestTourFarmApiculture(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_apiculture is defined and retrievable """
        ...
        xml_id = "farm_apiculture.action_farm_apiculture_operations"
        if xml_id:
