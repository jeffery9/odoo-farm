...
class TestTourFarmEntityReg(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_entity_reg is defined and retrievable """
        ...
        xml_id = "farm_entity_reg.action_farm_cooperative_member"
        if xml_id:
