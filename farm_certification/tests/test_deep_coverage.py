...
class TestDeepCoverageFarmCertification(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'purchase.order', 'res.partner', 'farm.certification.dashboard', 'farm.gap.audit', 'farm.gap.certification', 'farm.gap.compliance.check', 'farm.partner.certification', 'farm.gap.requirement', 'stock.location']
