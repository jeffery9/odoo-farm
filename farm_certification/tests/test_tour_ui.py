...
class TestTourFarmCertification(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_certification is defined and retrievable """
        ...
        xml_id = "farm_certification.action_gap_certification"
        if xml_id:
