...
class TestTourFarmEsgSocial(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_social is defined and retrievable """
        ...
        xml_id = "farm_esg_social.action_social_diversity_metric"
        if xml_id:
