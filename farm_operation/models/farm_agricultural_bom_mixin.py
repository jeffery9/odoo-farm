...
class FarmAgriculturalBomMixin(models.AbstractModel):
    """
    ...
    _description = 'Farm Agricultural BOM Shared Logic'
...
class FarmAgriculturalBomLineMixin(models.AbstractModel):
    """
    Abstract base model for agricultural BOM line functionality.
    """
    _name = 'farm.agricultural.bom.line.mixin'
    _description = 'Farm Agricultural BOM Line Shared Logic'
