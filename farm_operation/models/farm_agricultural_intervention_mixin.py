...
class FarmAgriculturalInterventionMixin(models.AbstractModel):
    """
    ...
    _description = 'Farm Agricultural Intervention Shared Logic'
    ...
    def action_confirm(self):
        ...
        for mo in self:
            ...
            if mo.agri_task_id and mo.agri_task_id.land_parcel_id:
                ...
                for move in mo.move_raw_ids:
                    if hasattr(move.product_id, 'is_agri_input') and move.product_id.is_agri_input and not hasattr(move.product_id, 'is_safety_approved') or not move.product_id.is_safety_approved:
        ...
        if hasattr(super(FarmAgriculturalInterventionMixin, self), 'action_confirm'):
            return super(FarmAgriculturalInterventionMixin, self).action_confirm()
        return True
...
""".format(name=self.name)
    ...
    def button_mark_done(self):
        ...
        if hasattr(super(FarmAgriculturalInterventionMixin, self), 'button_mark_done'):
            return super(FarmAgriculturalInterventionMixin, self).button_mark_done()
        else:
