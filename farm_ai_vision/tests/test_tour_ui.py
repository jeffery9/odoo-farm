...
class TestTourFarmAiVision(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_ai_vision is defined and retrievable """
        ...
        xml_id = "farm_ai_vision.action_ai_visual_sorting"
        if xml_id:
