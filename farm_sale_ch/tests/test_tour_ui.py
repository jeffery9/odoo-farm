...
class TestTourFarmSaleCh(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_sale_ch is defined and retrievable """
        ...
        xml_id = "farm_sale_ch.action_export_country_standards"
        if xml_id:
