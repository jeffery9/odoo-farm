...
class TestIntegrationFarmWinery(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['farm.lot.wine', 'farm.winery.recipe', 'farm.winery.production', 'farm.winery.vessel']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_winery are available """
