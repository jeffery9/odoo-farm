...
class TestTourFarmWinery(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_winery is defined and retrievable """
        ...
        xml_id = "farm_winery.action_farm_winery_vessel"
        if xml_id:
