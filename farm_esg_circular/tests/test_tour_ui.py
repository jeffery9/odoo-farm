...
class TestTourFarmEsgCircular(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_esg_circular is defined and retrievable """
        ...
        xml_id = "farm_esg_circular.action_hazardous_waste_record"
        if xml_id:
