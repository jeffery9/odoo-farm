...
class TestDeepCoverageFarmSupplyAnalytics(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['supply.chain.risk.dashboard', 'inventory.optimization.line', 'inventory.optimization', 'farm.supply.risk.monitor', 'supply.chain.dashboard', 'farm.supply.chain.node', 'farm.supply.demand.forecast']
