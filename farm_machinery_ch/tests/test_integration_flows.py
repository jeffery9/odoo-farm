...
class TestIntegrationFarmMachineryCh(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_check = ['maintenance.equipment', 'farm.machinery.subsidy.application']

    def test_01_cross_model_dependencies(self):
        """ Verify that dependencies and XML IDs required by farm_machinery_ch are available """
