...
class TestTourFarmFloriculture(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_floriculture is defined and retrievable """
        ...
        xml_id = "farm_floriculture.action_farm_flower_order"
        if xml_id:
