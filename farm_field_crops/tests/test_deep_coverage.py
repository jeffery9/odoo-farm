...
class TestDeepCoverageFarmFieldCrops(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['stock.lot', 'farm.crop.bom.line', 'farm.crop.production', 'farm.crop.lot', 'mrp.production', 'farm.field.crop.operation', 'mrp.bom', 'farm.crop.bom']
