...
class TestTourFarmTraining(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_training is defined and retrievable """
        ...
        xml_id = "farm_training.action_farm_training_skill"
        if xml_id:
