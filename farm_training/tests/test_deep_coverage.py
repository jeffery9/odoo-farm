...
class TestDeepCoverageFarmTraining(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['hr.employee', 'farm.certificate.type', 'agri.training.skill', 'farm.training.session', 'agri.training.training_record', 'agri.training.certification', 'farm.training.certification', 'farm.training.training_record', 'farm.training.skill', 'mrp.production', 'farm.certificate']
