...
class AgriTrainingSkill(models.Model):
    _name = 'agri.training.skill'
    _description = 'Agricultural Training Skill'

    name = fields.Char(string='Skill Name', required=True)
    description = fields.Text(string='Description')

class AgriTrainingCertification(models.Model):
    _name = 'agri.training.certification'
    _description = 'Agricultural Training Certification'
...
class AgriTrainingTrainingRecord(models.Model):
    _name = 'agri.training.training_record'
    _description = 'Agricultural Training Record'
