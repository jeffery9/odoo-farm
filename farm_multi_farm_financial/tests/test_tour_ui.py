...
class TestTourFarmMultiFarmFinancial(HttpCase):
    def test_01_ui_action_availability(self):
        """ Verify that the primary action for farm_multi_farm_financial is defined and retrievable """
        ...
        xml_id = "farm_multi_farm_financial.action_cooperative_treasury_list"
        if xml_id:
