...
class TestDeepCoverageFarmMultiFarmFinancial(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        cls.models_to_test = ['subsidy.disbursement', 'cooperative.decision', 'internal.loan', 'dividend.distribution', 'cooperative.entity', 'cooperative.treasury', 'decision.audit', 'subsidy.disbursement.line', 'dividend.line', 'internal.credit', 'cooperative.member', 'multi.sign.process', 'share.transaction', 'internal.marketplace.transaction', 'credit.transaction', 'multi.sign.line']
