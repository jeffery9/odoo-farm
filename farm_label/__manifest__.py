{
    ...
    'description': """
        ...
        - Consumer Product Labels with Traceability QR [US-008-01]
        - Internal Batch/Lot Tags
        - Individual Animal Identification (Ear Tags) [US-001-04]
        - Land Parcel Signage with GIS/History QR [US-001-03]
    """,
    'author': 'Jeffery',
